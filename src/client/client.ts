...
const iscosahedronGeometry: THREE.IcosahedronGeometry = new THREE.IcosahedronGeometry()
...
const iscosahedron: THREE.Mesh = new THREE.Mesh(iscosahedronGeometry, material)
...
const scaleCubeFolder = cubeFolder.addFolder("Scale")
scaleCubeFolder.add(cube.scale, "x", -5, 5, 0.01)
scaleCubeFolder.add(cube.scale, "y", -5, 5, 0.01)
...
function regenerateIscosahedronGeometry() {
  let newGeometry = new THREE.IcosahedronGeometry(
    iscosahedronData.radius, iscosahedronData.detail
  )
